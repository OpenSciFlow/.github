...
It should execute only reviewed command templates declared in plugin manifests, after checking inputs, environment readiness, model-weight availability, license/citation metadata, and user approval requirements.
...
- **5 workflow templates drafted**, starting from protein-computing workflows.
